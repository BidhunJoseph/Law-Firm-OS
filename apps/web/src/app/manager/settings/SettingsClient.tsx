...
const memberColumns: ColumnDef<FirmMember>[] = [
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-3">
        ...
        <div className="font-medium text-gray-900">{row.getValue("name") || "Unnamed User"}</div>
      </div>
    ),
  },
  {
...
export default function SettingsClient({ initialMembers }: { initialMembers: FirmMember[] }) {
  ...
  const handleInvite = (e: React.FormEvent) => {
    ...
    // Mock server action for now since we weren't given an invite action yet
    setTimeout(() => {
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              ...
              <div className="xl:col-span-2 space-y-4">
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  ...
                  <div className="p-0">
                    <DataTable columns={memberColumns} data={initialMembers} />
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full text-gray-900 pl-9 pr-3 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-gray-400 shadow-sm"
